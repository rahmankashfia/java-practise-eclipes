...
public class TestServiceServiceLocator extends org.apache.axis.client.Service implements com.apex.user.service.TestServiceService {
    ...
    private java.lang.String TestService_address = "http://localhost:8080/user-service/services/TestService";
    ...
    public com.apex.user.service.TestService getTestService() throws javax.xml.rpc.ServiceException {
    ...
    public com.apex.user.service.TestService getTestService(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            com.apex.user.service.TestServiceSoapBindingStub _stub = new com.apex.user.service.TestServiceSoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (com.apex.user.service.TestService.class.isAssignableFrom(serviceEndpointInterface)) {
                com.apex.user.service.TestServiceSoapBindingStub _stub = new com.apex.user.service.TestServiceSoapBindingStub(new java.net.URL(TestService_address), this);
                _stub.setPortName(getTestServiceWSDDServiceName());
                return _stub;
            }
        }
    ...
    public javax.xml.namespace.QName getServiceName() {
        return new javax.xml.namespace.QName("http://service.user.apex.com", "TestServiceService");
    }
    ...
    public java.util.Iterator getPorts() {
        if (ports == null) {
            ...
            ports.add(new javax.xml.namespace.QName("http://service.user.apex.com", "TestService"));
        }
